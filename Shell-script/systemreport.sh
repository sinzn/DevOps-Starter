...
# Author: Shivam Singh(sinzn)
# Description: Simple System Health Check Script

LOGFILE="/home/ubuntu/sinzn/system_log/system-health-$(date +%F).log"
HOSTNAME=$(hostname)
DATE=$(date)
...
# Send the log file via email using Postfix
TO="annuss7838@gmail.com"
SUBJECT="System Health Report - $HOSTNAME - $(date +%F)"
